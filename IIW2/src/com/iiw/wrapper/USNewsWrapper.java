...
public class USNewsWrapper {
	
	public USNewsWrapper() throws IOException {
		for (int i = 1; i<=9;i++) {
			...
			wrap("http://grad-schools.usnews.rankingsandreviews.com/best-graduate-schools/top-engineering-schools/eng-rankings/page+"+i);
		}
	}
